		...
		if GetConVarNumber("cpt_scp_ntfannouncer") == 1 && util.IsSCPMap() then
			if CurTime() > SCP_GlobalNTFCoolDown then
				for _,v in ipairs(player.GetAll()) do
					v:SendLua("surface.PlaySound('cpthazama/scp/ntf/Announc.wav')")
				end
				SCP_GlobalNTFCoolDown = CurTime() +SoundDuration("cpthazama/scp/ntf/Announc.wav") +60
			end
		end
		self.IsLeader = true
		self:SetSkin(1)
...
function ENT:Leader_Announcements()
	timer.Simple(60,function()
		if self:IsValid() then
			if GetConVarNumber("cpt_scp_ntfannouncer") == 1 then
				for _,v in ipairs(player.GetAll()) do
					v:SendLua("surface.PlaySound('cpthazama/scp/ntf/AnnouncAfter1.wav')")
				end
			end
		end
	end)
	timer.Simple(120,function()
		if self:IsValid() then
			if GetConVarNumber("cpt_scp_ntfannouncer") == 1 then
				for _,v in ipairs(player.GetAll()) do
					v:SendLua("surface.PlaySound('cpthazama/scp/ntf/AnnouncAfter2.wav')")
				end
			end
		end
	end)
	timer.Simple(160,function()
		if self:IsValid() then
			if GetConVarNumber("cpt_scp_ntfannouncer") == 1 then
				for _,v in ipairs(player.GetAll()) do
					v:SendLua("surface.PlaySound('cpthazama/scp/ntf/AnnouncCameraCheck.wav')")
				end
			end
		end
	end)
	timer.Simple(210,function()
		if self:IsValid() then
			if GetConVarNumber("cpt_scp_ntfannouncer") == 1 then
				for _,v in ipairs(player.GetAll()) do
					v:SendLua("surface.PlaySound('cpthazama/scp/ntf/AnnouncCameraFound1.wav')")
				end
			end
		end
	end)
	timer.Simple(320,function()
		if self:IsValid() then
			if GetConVarNumber("cpt_scp_ntfannouncer") == 1 then
				for _,v in ipairs(player.GetAll()) do
					v:SendLua("surface.PlaySound('cpthazama/scp/ntf/ThreatAnnouncPossession.wav')")
				end
			end
		end
	end)
	timer.Simple(math.random(400,600),function()
		if self:IsValid() then
			if GetConVarNumber("cpt_scp_ntfannouncer") == 1 then
				for _,v in ipairs(player.GetAll()) do
					v:SendLua("surface.PlaySound('cpthazama/scp/ntf/ThreatAnnounc3.wav')")
				end
			end
		end
	end)
	timer.Simple(720,function()
		if self:IsValid() then
			if GetConVarNumber("cpt_scp_ntfannouncer") == 1 then
				for _,v in ipairs(player.GetAll()) do
					v:SendLua("surface.PlaySound('cpthazama/scp/ntf/ThreatAnnouncFinal.wav')")
				end
			end
		end
	end)
			...
			if self.IsLeader == true then
				...
				if GetConVarNumber("cpt_scp_ntfannouncer") == 1 then
					if didremove == true then
						...
						local glbsound
						if glbchance == 1 then
							glbsound = "surface.PlaySound('cpthazama/scp/ntf/Tesla1.wav')"
						elseif glbchance == 2 then
							glbsound = "surface.PlaySound('cpthazama/scp/ntf/Tesla2.wav')"
						else
							glbsound = "surface.PlaySound('cpthazama/scp/ntf/Tesla3.wav')"
						end
						for _,v in ipairs(player.GetAll()) do
							v:SendLua(glbsound)
						end
